...
export default function MessengerButton() {
  return (
    <a
      ...
      className="site-chrome fixed bottom-[calc(4.75rem+env(safe-area-inset-bottom))] right-4 z-40 flex size-12 items-center justify-center rounded-full bg-gradient-to-br from-[#00B2FF] to-[#006AFF] text-white shadow-lg shadow-[#006AFF]/40 transition-transform hover:scale-105 active:scale-95 md:bottom-6 md:right-6 md:size-14"
    >
